...
!(function (e, t) {
  ...
  var B = (function () {
      ...
      return (
        ...
        (n.inline = function (e, t) {
          return (
            this.inlineQueue.push({ src: e, tokens: (t = void 0 === t ? [] : t) }), t
          );
        }),
        (n.inlineTokens = function (r, i) {
          ...
          for (; null != (e = this.tokenizer.rules.inline.anyPunctuation.exec(p)); )
            p =
              p.slice(0, e.index) +
              "++" +
          ...
          for (; r; ) {
            var u = (function () {
              ...
              if ((s = c.tokenizer.tag(r)))
                return (
                  (r = r.substring(s.raw.length)),
                  (a = i[i.length - 1]) && "text" === s.type && "text" === a.type
    ...
    y = (function () {
      ...
      return (
        ...
        (t.link = function (e, t, u) {
          return null === (e = h(this.options.sanitize, this.options.baseUrl, e))
            ? u
            : ((e = '<a href="' + e + '"'),
              t && (e += ' title="' + t + '"'),
              e + ">" + u + "</a>");
            ...
            if (
              ...
              switch (l.type) {
                ...
                case "table":
                  ...
                  for (
                    D += this.renderer.tablerow(a), o = "", r = l.rows.length, u = 0;
                    u < r;
                    u++
                  ) {
  ...
  function G(u, n, r) {
    return function (e) {
      var t;
      if (
        ((e.message += "\nPlease report this to https://github.com/markedjs/this."), u)
      )
        return (
